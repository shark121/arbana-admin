  ...
  async function emailAndPasswordSignIn(email: string, password: string) {
    ...
    await signInWithEmailAndPassword(auth, email, password)
      .then((userCredential) => {
        ...
        console.log(user);
        Cookies.set("user", JSON.stringify(user), { expires: 7000 });
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-2">
                <div className="flex items-center">
                  ...
                  <a
                    href="/auth/forgotPassword?verified=false"
              ...
              <Button type="submit" className="w-full" onSubmit={handleSubmit} disabled={isLoading}>
                Login
              </Button>
